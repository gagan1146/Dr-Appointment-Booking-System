      ...
      <div className='bg-white border border-gray-400 rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll'>
        ...
        </div>
        {
          appointments.map((item, index) => (
            <div className='flex flex-wrap justify-between max-sm:gap-2 sm:grid sm:grid-cols-[0.5fr_3fr_1fr_3fr_3fr_1fr_1fr] items-center text-gray-500 py-3 px-6 border-b border-gray-400 hover:bg-gray-50' key={index}>
